...
class Orchestrator:
    ...
    def __init__(self):
        ...
        self.agents = {
            ...
            "nova": EngineerAgent(),
            "kai": FrontendEngineerAgent(),
            "zara": FullstackEngineerAgent(),
            "devops": DevOpsAgent(),
    ...
    def setup_schedules(self) -> None:
        ...
        self.scheduler.add_job(
            ...
            args=["nova"],
            id="nova_cycle",
            name="Nova (Backend Engineer) Cycle",
        )
        self.scheduler.add_job(
            self.run_agent,
            "interval",
            ...
            args=["kai"],
            id="kai_cycle",
            name="Kai (Frontend Engineer) Cycle",
        )
        self.scheduler.add_job(
            self.run_agent,
            "interval",
            ...
            args=["zara"],
            id="zara_cycle",
            name="Zara (Fullstack Engineer) Cycle",
        )
        self.scheduler.add_job(
            self.run_agent,
            "interval",
